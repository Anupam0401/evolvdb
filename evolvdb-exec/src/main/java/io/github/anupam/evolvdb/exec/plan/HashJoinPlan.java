...
public final class HashJoinPlan implements PhysicalPlan {
    ...
    private final Expr predicate; // expected equi-join predicate
    private final Schema outSchema;

    public HashJoinPlan(PhysicalPlan left, PhysicalPlan right, Expr predicate, Schema outSchema) {
        this.left = left;
        this.right = right;
    ...
    public PhysicalOperator create(ExecContext context) {
        throw new UnsupportedOperationException("HashJoinExec not implemented yet");
    }
