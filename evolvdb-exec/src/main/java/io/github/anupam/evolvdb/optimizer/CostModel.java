...
public interface CostModel {
    ...
    default Cost costNestedLoopJoin(Cost left, Cost right) {
        return costNestedLoopJoin(left, right, null);
    }

    default Cost costHashJoin(Cost left, Cost right) {
        return costHashJoin(left, right, null);
    }

    default Cost costSortMergeJoin(Cost left, Cost right) {
        return costSortMergeJoin(left, right, null);
    }
