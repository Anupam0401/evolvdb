...
public final class InsertExec implements PhysicalOperator {
    ...
    public Tuple next() throws Exception {
        ...
        for (List<Expr> row : insert.rows()) {
            ...
            for (int i = 0; i < row.size(); i++) {
                ...
                if (targetCol.type() == io.github.anupam.evolvdb.types.Type.INT
            ...
            for (ColumnMeta col : tableSchema.columns()) {
                ...
                if (idx >= 0) {
                    ...
                    throw new IllegalStateException(
                            "Column " + col.name() + " not specified in INSERT and no default");
                }
            }
        ...
        Schema resultSchema =
                new Schema(
                        List.of(
                                new ColumnMeta(
                                        "inserted_count",
                                        io.github.anupam.evolvdb.types.Type.INT,
                                        null)));
    ...
    public Schema schema() {
        ...
        return new Schema(
                List.of(
                        new ColumnMeta(
                                "inserted_count", io.github.anupam.evolvdb.types.Type.INT, null)));
    }
