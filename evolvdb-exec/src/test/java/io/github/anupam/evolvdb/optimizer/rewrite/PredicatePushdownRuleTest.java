    ...
    void pushes_left_only_predicate_into_left_child() {
        ...
        Expr join =
                new ComparisonExpr(
                        ...
                        new ColumnRef(new SourcePos(1, 1), "u", "id"),
                        new ColumnRef(new SourcePos(1, 1), "o", "user_id"));
        LogicalPlan j =
                new LogicalJoin(
                        u,
                        o,
                        ...
                        join,
                        new Schema(List.of(new ColumnMeta("u.id", Type.INT, null))));
        ...
        Expr pred =
                new ComparisonExpr(
                        new SourcePos(1, 1),
                        ComparisonExpr.Op.EQ,
                        new ColumnRef(new SourcePos(1, 1), "u", "name"),
                        new Literal(new SourcePos(1, 1), "Alice"));
        ...
        assertFalse(
                containsFilter(rj.right()),
                "Right side should not contain a filter for left-only predicate");
    }
    ...
    void retains_mixed_predicate_above_join() {
        ...
        Expr right =
                new ComparisonExpr(
                        ...
                        new ColumnRef(new SourcePos(1, 1), "o", "amount"),
                        new Literal(new SourcePos(1, 1), 10));
