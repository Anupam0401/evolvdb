...
public interface AstVisitor<R, C> {
    ...
    default R visitCreateTable(CreateTable node, C context) {
        return visitNode(node, context);
    }

    default R visitDropTable(DropTable node, C context) {
        return visitNode(node, context);
    }
    ...
    default R visitColumnRef(ColumnRef node, C context) {
        return visitNode(node, context);
    }

    default R visitBinaryExpr(BinaryExpr node, C context) {
        return visitNode(node, context);
    }

    default R visitLogicalExpr(LogicalExpr node, C context) {
        return visitNode(node, context);
    }

    default R visitComparisonExpr(ComparisonExpr node, C context) {
        return visitNode(node, context);
    }
    ...
    default R visitTableRef(TableRef node, C context) {
        return visitNode(node, context);
    }
