...
public final class LogicalUpdate implements LogicalPlan {
    ...
    public LogicalUpdate(LogicalPlan child, String tableName, Map<String, Expr> assignments, Schema tableSchema) {
    ...
    @Override public <R, C> R accept(LogicalPlanVisitor<R, C> visitor, C context) { return visitor.visitUpdate(this, context); }
}
